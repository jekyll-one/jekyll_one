...
publish (RubyGems):                   gem push j1-template-2021.1.1.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.1.1
...
uninstall (version):                  gem uninstall j1-template -v 2021.1.1
uninstall (version/forced):           gem uninstall j1-template -v 2021.1.1 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.1.1 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.1.1"
