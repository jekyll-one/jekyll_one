/*
 ...
 #  Provides Javascript functions for Bootstrap Datepicker
 #
 #  Product/Info:
 #  http://jekyll.one
 ...
 #  Copyright (C) 2012-2013 Stefan Petre
 #
 #  J1 Template is licensed under the MIT License.
 #  See: https://github.com/jekyll-one-org/J1 Template/blob/master/LICENSE
 #  Datepicker is licensed under the Apache License, Version 2.0
...
(function($, window, document) {
  ...
  Datepicker.prototype = {
    ...
    show: function(e) {
      ...
      setTimeout(function(){
        // jadams, 207-12-28: first time, the days widget is set to display none
  ...
  // jadams, 2017-12-28: added style display:none to te template
  DPGlobal.template = '<div class="datepicker dropdown-menu" style="display:none;">'+
