...
*/
    ...
    v.O = function() {
        ...
        er(this.l, C(function() {
            var f = Eg(this.l);
            var h = e;
            h = pk(ja + X(Dk(b)) + '"></head><body class="goog-te-ftab ' + X(h) + '" scroll="no" style="overflow:hidden" dir="' + X(a) + '"><a id="' + X(c) + '" href="#" class="goog-te-ftab-link"><img src="' + X(Bk(vb)) + aa + X(Bk(Nq)) + ');background-position:-65px 0px"><span>' + ok(Z.Lf) + "</span></a></body>");
            h = hk(h);
            f.write(ke(h));
            f.close()
        }, this))
